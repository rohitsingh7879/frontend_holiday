        ...
        <>
                              ...
                              <div>
                                ...
                                {[
                                  ...
                                  <>
                                    <del>WAS £19209pp</del>{" "}
                                    <b>
                                      NOW £ {shipRefData?.[0]?.suite_price} PP
                                    </b>
                                  </>
                                )}
                              </div>
                        ...
                        <div className="row">
                          ...
                          <div className="col-lg-12">
                            <div className="why_block">
                              ...
                              <p>
                                Entrust your voyage to our elite team of
                                seasoned experts, dedicated to tailoring every
                          ...
                          <div className="col-lg-12">
                            <div className="why_block">
                              ...
                              <h3>
                                Unrivalled Financial Security with ATOL
                                Protection
                              </h3>
                              <p>
                                Embark with absolute confidence, assured that
                                your investment is impeccably safeguarded.
                              </p>
                            </div>
                          </div>
                          <div className="col-lg-12">
                          ...
                          <div className="col-lg-12">
                            <div className="why_block">
                              ...
                              <p>
                                Delight in seamless, attentive support that
                                ensures an effortless experience from your first
                                inquiry to your final destination.
                              </p>
                            </div>
                          </div>
                        </div>
          ...
          <section className="new_subscribe">
            <div className="container">
              ...
              <p>
                Subscribe to our Newsletter for the latest offers and deals!
              </p>
              <div className="subm">
                <input
                  type="text"
